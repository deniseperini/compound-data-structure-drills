...
puts "there are #{people.keys.length} people in the hash people."
# * What are the names of all the people?value
people.each do |name, personal_info|
  puts name
end
...
puts "The people who have children are:"
people.each do |name, personal_info|
  if !personal_info['children'].nil?
    puts "#{name}"
  end
end
...
people.each do |name, personal_info|
  if personal_info['children'].nil?
    puts "The people who have no children are #{name}"
  end
end
...
sets_of_people[0].each do |name, personal_info|
   if personal_info['company'].include?('m')
    puts name
  end
end
